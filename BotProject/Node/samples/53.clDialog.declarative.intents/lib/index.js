...
const path = "./node_modules/botbuilder-dialogs-declarative/tests/resources/16 - CLDialogMore/CLDialogMore.main.dialog";
const resourcesFolder = "./node_modules/botbuilder-dialogs-declarative/tests/resources/16 - CLDialogMore";
...
async function LoadDialog(path, resourcesFolder) {
    readPackageJson(path, async function (err, json) {
        ...
        if (resourcesFolder) {
            ...
            resourceProvider.registerDirectory(`./node_modules/botbuilder-dialogs-declarative/tests/resources`);
